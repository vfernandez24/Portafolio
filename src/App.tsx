        ...
        >
          ...
          <div className="section_proyectos__contenedorProyectos w-[80vw] flex flex-col gap-[50px] items-center m-auto pt-10 justify-start max-md:gap-0">
            <Project
              ...
              imgSrc="/Portafolio/public/planitUp.png"
              skills={
                <>
                  <Skill
                    text="CSS3"
            ...
            <Project
              ...
              imgSrc="/Portafolio/public/byteZone.png"
              skills={
                <>
                  <Skill
                    text="CSS3"
            ...
            <Project
              ...
              imgSrc="/Portafolio/public/tiendaLocalStorage.png"
              skills={
                <>
                  <Skill
                    text="CSS3"
            ...
            <Project
              ...
              imgSrc="/Portafolio/public/randomColor.png"
              skills={
                <>
                  <Skill
                    text="CSS3"
